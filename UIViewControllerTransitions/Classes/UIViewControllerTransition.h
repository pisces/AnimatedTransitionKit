...
@property (nonnull, nonatomic, strong) AbstractInteractiveTransition *dismissionInteractor;
@property (nonnull, nonatomic, strong) AbstractInteractiveTransition *presentingInteractor;
