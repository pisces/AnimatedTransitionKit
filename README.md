...
> CocoaPods 1.1.0+ is required to build UIViewControllerTransitions 3.2.6+.
...
target '<Your Target Name>' do
    pod 'UIViewControllerTransitions', '~> 3.2.6'
end
```
...
```ogdl
github "pisces/UIViewControllerTransitions" ~> 3.2.6
```
